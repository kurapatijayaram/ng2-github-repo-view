...
var RepoViewer = (function () {
    function RepoViewer(_rvs, _window) {
        ...
        this._branchChange$.subscribe(function (data) {
            _this._rvs.fetchBranch(_this.defaultBranch).subscribe(function (data) {
                _this._changeTree$.next({ type: "tree", sha: data.commit.tree.sha, path: _this._rvs.repoName });
            });
        });
    }
    ...
    RepoViewer.prototype.ngOnInit = function () {
        ...
        if (this.commitId == null) {
            ...
            this._rvs.fetchCommit(this.commitId).subscribe(function (data) {
                _this._changeTree$.next({ type: "tree", sha: data.commit.tree.sha, path: _this._rvs.repoName });
            });
        }
    };
    ...
    RepoViewer.prototype.ngOnDestroy = function () {
    ...
    __decorate([
        core_1.Input("commitId"), 
        __metadata('design:type', String)
    ], RepoViewer.prototype, "commitId", void 0);
    __decorate([
        core_1.Input("handle"), 
        __metadata('design:type', String), 
